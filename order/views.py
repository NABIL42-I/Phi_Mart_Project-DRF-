...
from order.serializers import CartSerializer,CartItemSerializer,AddCartItemSerializer,UpdateCartItemSerializer,OrderSerializer,EmptySerializer
from order.serializers import CreateOrderSerializer,UpdateOrderSerializer
...
def initiate_payment(request):
    ...
    settings = { 'store_id': 'phima6a3619308555e', 'store_pass': 'phima6a3619308555e@ssl', 'issandbox': True }
